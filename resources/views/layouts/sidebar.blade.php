        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                @can('qarorlar.show')
                    ...
                    <li
                        class="{{ Request::is('documents*') && (request()->query('status_type') == 'kiruvchi' || request()->query('status_type') == 'chiquvchi') ? 'mm-active' : '' }}">
                        <a href="javascript: void(0);"
                            class="has-arrow waves-effect {{ Request::is('documents*') && (request()->query('status_type') == 'kiruvchi' || request()->query('status_type') == 'chiquvchi') ? 'mm-active' : '' }}">
                            <i class="bx bxs-magic-wand"></i>
                            <span>Хатлар</span>
                        </a>
                        <ul class="sub-menu {{ Request::is('documents*') && (request()->query('status_type') == 'kiruvchi' || request()->query('status_type') == 'chiquvchi') ? '' : 'd-none' }}"
                            aria-expanded="false">
                            @can('category.show')
                                <li>
                                    <a href="{{ route('documents.index', ['status_type' => 'kiruvchi']) }}"
                                        class="{{ Request::is('documents*') && request()->query('status_type') == 'kiruvchi' ? 'mm-active' : '' }}">
                                        <i class="bx bx-border-all" style="min-width: auto;"></i>
                                        Kiruvchi
                                    </a>
                                    <a href="{{ route('documents.index', ['status_type' => 'chiquvchi']) }}"
                                        class="{{ Request::is('documents*') && request()->query('status_type') == 'chiquvchi' ? 'mm-active' : '' }}">
                                        <i class="bx bx-border-all" style="min-width: auto;"></i>
                                        Chiquvchi
                                    </a>
                                </li>
                ...
                @can('monitoring.show')
                    <li class="{{ Request::is('monitoring*') ? 'mm-active' : '' }}">
                        <a href="{{ route('monitoringIndex') }}"
                            class=" waves-effect {{ Request::is('monitoring*') ? 'mm-active' : '' }}">
                ...
                {{-- files end --}}
                <!-- Manage -->
                @canany(['category.show', 'long-text.show', 'employee.show'])
                    <li
                        class="{{ Request::is('company*') || Request::is('category*') || Request::is('driver*') || Request::is('cheque*') || Request::is('long*') || Request::is('employee*') ? 'mm-active' : '' }}">
                        <a href="javascript: void(0);"
                            class="has-arrow waves-effect {{ Request::is('company*') || Request::is('category*') || Request::is('driver*') || Request::is('cheque*') || Request::is('long*') || Request::is('employee*') ? 'mm-active' : '' }}">
                            <i class="bx bxs-magic-wand"></i>
                            <span>Управлять</span>
                        </a>
                        <ul class="sub-menu {{ Request::is('company*') || Request::is('category*') || Request::is('driver*') || Request::is('cheque*') || Request::is('long*') || Request::is('employee*') ? ' ' : 'd-none' }}"
                            aria-expanded="false">
                            @can('category.show')
                                <li>
                                    <a href="{{ route('categoryIndex') }}"
                                        class="{{ Request::is('category*') ? 'mm-active' : '' }}">
                                        <i class="bx bx-border-all" style="min-width: auto;"></i>
                                        Категория
                                    </a>
                                </li>
                            ...
                            @can('employee.show')
                                <li>
                                    <a href="{{ route('employeeIndex') }}"
                                        class="{{ Request::is('employee*') ? 'mm-active' : '' }}">
                ...
                <!-- Report -->
                @canany(['control-report.show', 'shift.show', 'fines.show', 'bonuses.show', 'request-history.show'])
                @endcanany
                    ...
                    @can('api-user.view')
                        <li class="{{ Request::is('api-user*') ? 'mm-active' : '' }}">
                            <a href="{{ route('api-userIndex') }}"
                                class=" waves-effect {{ Request::is('api-users*') ? 'mm-active' : '' }}">
