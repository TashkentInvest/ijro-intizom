                        ...
                        <div class="col-lg-3 email-aside border-lg-right">
                            <div class="aside-content">
                                ...
                                <div class="aside-nav collapse">
                                    <ul class="nav">
                                        <li><a href="../../../demo_1/pages/email/inbox.html"><span class="icon"><i
                                                        data-feather="inbox"></i></span>Inbox<span
                                                    class="badge badge-danger-muted text-white font-weight-bold float-right">2</span></a>
                                        </li>
                                        <li class="active"><a href="#"><span class="icon"><i
                                                        data-feather="mail"></i></span>Sent Mail</a></li>
                                    ...
                                    <div class="form-group row py-0">
                                        ...
                                        <div class="col-md-11">
                                            <div class="form-group">
                                                <select class="compose-multiple-select form-control w-100"
                                                    multiple="multiple">
